				...
				<div class="content-wrapper">
					...
					<section class="content">
						<div id="sms-top-bar" class="row">
							<div id="screen-name">EDIT STUDENT</div>
							<div id="action-buttons">
								...
								<a href="student?astudS03=student_detail&studentNo=<%=studentDetails[0]%>" style="color: white;">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="controls">
												<input type="text" name="SurNameKana" maxlength="32" value="<%=studentDetails[14] != null ? studentDetails[14] : ""%>" class="form-control" placeholder="Surname (Kana)">
											</div>
										</div>
									</div>
									<!-- /Surname (Kana) -->
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="controls">
												<input type="text" name="FirstNameKana" maxlength="32" value="<%=studentDetails[15] != null ? studentDetails[15] : ""%>" class="form-control" placeholder="First name (Kana)">
											</div>
										</div>
									</div>
									<!-- /First name (Kana) -->
									...
									<div class="col-md-3">
										<div class="form-group <%=(request.getAttribute("birthdayError") != null) ? "has-error" : ""%>">
											...
											<div class="controls">
												...
												<input type="text" name="Birthday" value="<%=request.getAttribute("Birthday") != null
		? request.getAttribute("Birthday")
		: (birthday != null ? DateUtils.formatDate(birthday) : "")%>" class="form-control datepicker" placeholder="Birthday (dd/MM/yyyy)" />
